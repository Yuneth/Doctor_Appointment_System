...
if (strlen($_SESSION['id'] == 0)) {
	...
	//Set sender email
	$mail->setFrom('Add your email address');
	//Enable HTML
	$mail->isHTML(true);
	//Attachment
	...
	$mail->Body = "<h2>Account Registration is Successful !!</h2>
					</br><p> Dear Doctor $docname,</p> 
					</br><p>To confirm your email address and activate your account, please click on the following link: http://localhost/Doctor_Appointment_System/hms/doctor/</P>
	...
	$mail->smtpClose();
			...
			// Redirect the user to the manage-doctors.php
