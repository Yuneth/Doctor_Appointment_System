			...
			<div class="box-login">
				<form class="form-login" method="post">
					<fieldset>
						...
						<!-- <a href="http://localhost/Doctor_Appointment_System/index.php#">Back to Home Page</a> -->
				...
				<div class="copyright">
					</span><span class="text-bold text-uppercase"> Doctor Channelling System</span>.
				</div>
