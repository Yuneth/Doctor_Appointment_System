					...
					<ul class="nav header-navbar-rht">
						<li class="nav-item contact-item">
							...
							<div class="header-contact-detail">
								...
								<p class="contact-info-header"> +94 382287458</p>
							</div>
						</li>
						...
						<li class="nav-item dropdown has-arrow logged-item">
							<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
								<span class="user-img">
									<img class="rounded-circle" src="assets/img/patients/patient2.jpg" width="31" alt="Ryan Taylor">
								</span>
							</a>
												...
												<div class="user-details mr-auto">
													<div class="float-left user-img">
														<a class="avatar avatar-sm mr-2" href="#" title="Charlene Reed">
															<img src="assets/img/patients/patient2.jpg" alt="User Image" class="rounded-circle">
															<span class="status online"></span>
														</a>
													</div>
													<div class="user-info float-left">
														<a href="#"><span>Yuneth Perera</span></a>
										...
										<div class="call-contents">
											<div class="call-content-wrap">
												<div class="voice-call-avatar">
													<img src="assets/img/doctors/doctor-thumb-08.jpg" alt="User Image" class="call-avatar">
													<span class="username">Dr. Kushal Fernando</span>
												...
												<div class="call-users">
													<ul>
														<li>
															<a href="#">
																<img src="assets/img/patients/patient2.jpg" class="img-fluid" alt="User Image">
