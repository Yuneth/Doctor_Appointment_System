...
<head>
    ...
    <title> Doctor Channelling System </title>
...
<body>
    ...
    <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:40px; margin-top: 1% !important;">Swabhasri
                    ...
                    <div id="menu" class="col-lg-8 col-md-9 d-none d-md-block nav-item">
                        <ul>
                            ...
                            <li><a href="http://localhost/simple_chat_bot/index.php"> ChatBot</a></li>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Doctor Channelling System</h5>
